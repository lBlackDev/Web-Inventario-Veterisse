...
export function MovementTable() {
  const [tableMovements, setTableMovements] = useState(movements)
  const [movementPagination, setMovementPagination] = useState(movements)

  const handleChangePage = (contentPage: any[]) => {
    setMovementPagination(contentPage)
  }
    ...
    <div className="space-y-4">
      <div className="rounded-md border">
        <Table>
          ...
          <TableBody>
            {movementPagination.map((movement) => (
